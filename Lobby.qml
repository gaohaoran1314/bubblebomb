...
Rectangle {
    ...
    Column {
        ...
        Text { text: "多人联机"; font.pixelSize: 48; color: "white"; anchors.horizontalCenter: parent.horizontalCenter }

        Rectangle {
            width: 200; height: 60; color: "#27ae60"; radius: 10; anchors.horizontalCenter: parent.horizontalCenter
        ...
        Rectangle {
            width: 300; height: 150; color: "#34495e"; radius: 10; anchors.horizontalCenter: parent.horizontalCenter
            Column {
                anchors.centerIn: parent; spacing: 10
                Text { text: "加入游戏"; font.pixelSize: 20; color: "white"; anchors.horizontalCenter: parent.horizontalCenter }
                Rectangle {
                    width: 200; height: 40; color: "white"; radius: 5; anchors.horizontalCenter: parent.horizontalCenter
                    TextInput { id: ipInput; anchors.fill: parent; anchors.margins: 5; font.pixelSize: 16; text: "输入主机IP"; color: "black" }
                }
                Rectangle {
                    width: 120; height: 40; color: "#3498db"; radius: 8; anchors.horizontalCenter: parent.horizontalCenter
        ...
        Rectangle {
            width: 120; height: 40; color: "#7f8c8d"; radius: 8; anchors.horizontalCenter: parent.horizontalCenter
